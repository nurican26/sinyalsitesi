...
KILIT_DOSYASI = "oda_durumu.txt"

if "sohbet_gecmisi" not in st.session_state:
    st.session_state["sohbet_gecmisi"] = []

# 🌐 KÜRESEL KİLİT KONTROLÜ (TÜM KULLANICILAR İÇİN ORTAK DOSYA OKUMA)
def oda_kilitli_mi_kontrol_et():
...
# 🌐 KÜRESEL KİLİT DURUMUNU DEĞİŞTİRME FONKSİYONU
def kilit_durumunu_degistir():
    su_an_kilitli = oda_kilitli_mi_kontrol_et()
    yeni_durum = "acik" if su_an_kilitli else "kilitli"
