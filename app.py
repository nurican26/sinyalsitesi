...
col_sayac.markdown(f'<div style="text-align:right; color:#00ffcc; font-weight:bold; margin-top:25px; font-size:18px;">👥 kişi sayısı: {gercek_canli_kisi} Kişi</div>', unsafe_allow_html=True)
