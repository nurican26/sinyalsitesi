...
if is_admin:
    ...
    col_ac, col_kilitle, col_sil = st.columns(3)
...
if erisim_izni:
    ...
    # 💬 3 SANİYEDE BİR ARKA PLANDA KENDİNİ YENİLEYEN SOHBET ODASI MODÜLÜ
    ...
    def sohbet_alani():
        ...
        if mesajlar:
            ...
            chat_html += '<div style="color: #94a3b8; text-align: center; padding: 10px; margin-top: 100px;">Henüz mesaj yok. İlk mesajı siz yazın!</div>'
        chat_html += '</div>'
    ...
    with st.form("chat_formu", clear_on_submit=True):
        col_isim, col_mesaj, col_buton = st.columns([1.5, 5, 1])
