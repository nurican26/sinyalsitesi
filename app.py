...
with sol_taraf:
    ...
    # 🟡 1. ADIM: AL SAT SİNYAL GÖSTERİMİ (Uyarı tamamen silindi)
    if al_sat_butonu:
    ...
    # 📦 SADECE AL SİNYALİ GELEN HİSSELERİN TAKİP KUTUSU (GÜNCEL SÜTUNLAR)
...
with sag_taraf:
    ...
    # Python 3.14 Hizalaması ve Boşlukları Kusursuzlaştırılmış Yönetici Girişi
