...
# Veritabanını sadece hedef_fiyat içerecek şekilde en temiz haliyle başlatıyoruz
...
with col_not1:
    ...
    not_hisse_secim = st.selectbox("Not Alınacak Hisse", ["Manuel Gir..."] + tum_hisseler, key="not_hisse_v_sec")
