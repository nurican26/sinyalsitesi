...
# 🌟 YENİ NESİL LOGO: KÜÇÜK ÇERÇEVE ETRAFINDA YUVARLAK DÖNEN YILDIZLAR VE HAFİF KAYMA/SALLANMA EFEKTİ
st.markdown("""
<style>
@keyframes neon-isik {
    0% { 
        ...
        try:
            if len(df_kaynak.columns) > 22:
                ...
                if uv and uv not in ["NAN", "NONE", "AL_SAT SİNYALİ"]:
                    ...
                    if h_ara:
                        hisse = str(h_ara[0]).strip() # Köşeli parantezleri kaldıran temizleme hamlesi
