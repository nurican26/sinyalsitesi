...
# 1. Sayfa Yapılandırması ve Neon Tasarım (SPK Kutusu CSS'i Dahil)
...
if erisim_izni:
        ...
        for idx in range(2, len(df_kaynak)):
            try:
                if len(df_kaynak.columns) > 22:
                    ...
                    # 19. İndeks Excel'deki T sütununu yalın bir şekilde okur
                    ...
                    if uv and uv not in ["NAN", "NONE", "AL_SAT SİNYALİ"]:
                        ...
                        if h_ara:
                            ...
                            # BTA Puanı sadece ve doğrudan T sütunundan (t_deg) alıyoruz
    ...
    # 🏢 SPK YASAL UYARI KUTUSU (Geri eklenen kısım)
    st.markdown('<div class="spk-kutusu"><b>YASAL UYARI:</b> Burada yer alan yatırım bilgi, yorum ve tavsiyeleri yatırım danışmanlığı kapsamında değildir. Yatırım danışmanlığı hizmeti, aracı kurumlar, portföy yönetim şirketleri, mevduat kabul etmeyen bankalar ile müşteri arasında imzalanacak yatırım danışmanlığı sözleşmesi çerçevesinde sunulmaktadır. Burada yer alan yorum ve tavsiyeler, yorum ve tavsiyede bulunanların kişisel görüşlerine dayanmaktadır. Bu görüşler mali durumunuz ile risk ve getiri tercihlerinize uygun olmayabilir. Bu nedenle, sadece burada yer alan bilgilere dayanılarak yatırım kararı verilmesi beklentilerinize uygun sonuçlar doğurmayabilir.</div>', unsafe_allow_html=True)
